# Historical sources, quotations, image rights, and editorial boundaries

This source log documents the historical and humanities material used in *The Shape of Myth*. It supplements `METHODS_AND_PROVENANCE.md`, which remains the authority for the computational analysis.

No generative-AI imagery, stock mythology art, invented community voice, or anonymous “traditional” quotation appears in the story. Every historical image is linked to an institutional item record, and every direct quotation is linked to the exact or authoritative source used for verification.

## Editorial boundary

The historical photographs and museum objects are **contextual counterpoints**, not observations sampled from the 926 catalogue records. They must not be read as representatives of B1–B4, T1–T5, or any network community. Their function is to make visible the media, encounters, collection practices, and systems of classification that precede computational comparison.
...
- Original essay: Zora Neale Hurston, “Folklore and Music,” *Frontiers* 12, no. 1 (1991), 183–198, especially p. 183. [JSTOR record](https://www.jstor.org/stable/3346585).
- Scholarly text verification: Cheryl A. Wall, [“Zora Neale Hurston’s Essays: On Art and Such”](https://sfonline.barnard.edu/hurston/wall_06.htm), Barnard Center for Research on Women.
- Editorial note: the line is frequently misattributed to *Mules and Men*. The story attributes it to “Folklore and Music.”
...
- Source: UNESCO, [Convention for the Safeguarding of the Intangible Cultural Heritage](https://ich.unesco.org/en/convention), 2003, Article 2.1.
- Use: establishes living heritage as practice recreated in social and historical context rather than as a static survival.

### Juana Batz Puac

> “Maize is sacred to us because it connects us with our ancestors. It feeds our spirit as well as our bodies.”
...
- Source: Michel-Rolph Trouillot, *Silencing the Past: Power and the Production of History* (Boston: Beacon Press, 1995), p. 27.
- Verification: [authorized excerpt hosted by NYU Manifold](https://nyu.manifoldapp.org/read/silencing-the-past-excerpt-trulliot/section/2f251038-7193-4e95-aba1-01953ed871c3); [publisher record](https://www.beacon.org/Silencing-the-Past-P1109.aspx).

### Geoffrey C. Bowker and Susan Leigh Star

> “Each standard and each category valorizes some point of view and silences another.”

- Source: Geoffrey C. Bowker and Susan Leigh Star, *Sorting Things Out: Classification and Its Consequences* (MIT Press, 1999), p. 5.
- Publisher: [MIT Press book record](https://mitpress.mit.edu/9780262522953/sorting-things-out/).
- Use: frames classification as a substantive point of view rather than neutral clerical preparation.

### Yuri E. Berezkin

> “It is normally impossible to reconstitute the content of any real text on the basis of the set of motifs extracted.”

- Source: Yuri E. Berezkin, [“Folklore and Mythology Catalogue: Its Lay-Out and Potential for Research”](https://sisu.ut.ee/wp-content/uploads/sites/172/berezkin_folklore_and_mythology_catalogue_its_lay-1_out_and_potential_for_research.pdf), displayed p. 37 / PDF p. 4.
- Use: preserves the catalogue creator’s distinction between extracted motifs and complete narratives.

### Stephanie Russo Carroll and colleagues

> “Indigenous nations and communities must be the ones to determine data governance protocols.”

- Source: Stephanie Russo Carroll et al., [“The CARE Principles for Indigenous Data Governance”](https://www.gida-global.org/s/dsj-1158_carroll.pdf), *Data Science Journal* 19 (2020), article p. 6. [Journal record](https://datascience.codata.org/articles/dsj-2020-043).
- Use: distinguishes public availability from authority over culturally situated data.

## Historical image and object records

### Cover map

- **Title:** *Orbis terrarum typus de integro multis in locis emendatus*
- **Creators:** Claes Jansz. Visscher, cartographer; Pieter Goos, engraver
- **Date:** 1652
- **Holding institution:** Library of Congress, Geography and Map Division
- **Item record:** <https://www.loc.gov/item/2017585799/>
- **Local derivative:** `assets/history/visscher-world-map-1652.jpg`, downloaded through the Library of Congress IIIF service at 2,400 pixels wide
...
- **Current title:** “[Piegan Indian, Mountain Chief, listening to recording with ethnologist Frances Densmore]”
- **Date:** 1916
- **Collection:** National Photo Company Collection
- **Holding institution:** Library of Congress, Prints and Photographs Division
- **Item record:** <https://www.loc.gov/pictures/item/93503097/>
- **Direct large JPEG:** <https://tile.loc.gov/storage-services/service/pnp/ppmsca/51000/51096v.jpg>
- **Local file:** `assets/history/mountain-chief-densmore-1916.jpg`
...
- **Date:** ca. seventh–sixth century BCE
- **Material:** clay
- **Object number:** 86.11.378a
- **Holding institution:** The Metropolitan Museum of Art
- **Item record:** <https://www.metmuseum.org/art/collection/search/321999>
- **Direct image:** <https://images.metmuseum.org/CRDImages/an/web-large/DP-16190-011.jpg>
- **Local file:** `assets/history/atrahasis-tablet.jpg`
...
- **Interpretive use:** illustrates the Greek example in the role-of-myth passage. The caption explicitly states that this single Attic object does not represent the Korean or Māori traditions discussed beside it.

### Painted folio from *Kalila wa Dimna*

- **Title:** *“The Monkey Tells the Story of the Fox Luring the Ass to Its Death by the Lion,” Folio from a Kalila wa Dimna*
- **Date and geography:** second quarter of the sixteenth century; attributed to India, Gujarat, probably based on an Egyptian original
- **Material:** ink and opaque watercolor on paper
- **Object number:** 1981.373.78
- **Holding institution:** The Metropolitan Museum of Art
- **Item record:** <https://www.metmuseum.org/art/collection/search/453130>
- **Direct image:** <https://images.metmuseum.org/CRDImages/is/web-large/DP300776.jpg>
- **Local file:** `assets/history/kalila-dimna-storytelling-folio.jpg`
- **Rights:** Public Domain; The Met Open Access
...
- **Artist:** Metropolitan Painter
- **Culture and geography:** Maya; Guatemala or Mexico
- **Date:** 600–800 CE
- **Material:** ceramic, slip
- **Object number:** 1978.412.206
- **Holding institution:** The Metropolitan Museum of Art
- **Item record:** <https://www.metmuseum.org/art/collection/search/310364>
...
- **Holding institution:** The Metropolitan Museum of Art
- **Item record:** <https://www.metmuseum.org/art/collection/search/688474>
- **Direct image:** <https://images.metmuseum.org/CRDImages/as/web-large/DP702157.jpg>
- **Local file:** `assets/history/rama-hanuman.jpg`
- **Rights:** Public Domain; The Met Open Access
...
## Additional archived visual candidates (continued)

### Vishnu Narayana on the divine serpent Shesha print — archived visual candidate
...
- GRIMMWELT Kassel, [“Die Kinder- und Hausmärchen”](https://www.grimmwelt.de/de/journal/die-kinder-und-hausmaerchen). Used to verify that the Grimms began collecting in 1806, published the first volume in 1812, and repeatedly revised the collection; the timeline treats those revisions as evidence that preservation is also interpretation.
...
- Hans-Jörg Uther, [introduction to the revised and supplemented 2024 edition of *The Types of International Folktales*](https://www.folklorefellows.fi/wp-content/uploads/FFC-284-286-Uther-2024-Introductions.pdf). Used to verify Thompson’s 1928 and 1961 revisions, the Northern European concentration of the earlier system, Uther’s comprehensive 2004 revision, and the stated limits of any international tale-type taxonomy.
- Folklore Fellows, [*The Types of International Folktales*, revised and supplemented edition](https://www.folklorefellows.fi/ffc-284-286-2024-edition/) (2024). Used to verify the current ATU edition and its continuing role as an international tale-type index.
- University of Pennsylvania, [Online Books Page record for Thompson’s revised and enlarged *Motif-Index of Folk-Literature*](https://onlinebooks.library.upenn.edu/webbin/book/lookupid?key=olbp74446), together with the bibliographic record in Cambridge University Press’s [“Indexing of Folk and Oral Literature in the Islam-Dominated Cultural Area”](https://www.cambridge.org/core/journals/bulletin-of-the-school-of-oriental-and-african-studies/article/indexing-of-folk-and-oral-literature-in-the-islamdominated-cultural-area1/8B379FA0EF51C0CA6E31ED8E665D3C55). Used to verify the first six-volume edition of 1932–1936 and the revised six-volume edition of 1955–1958.
...
- Berezkin–Duvakin, [Electronic Analytical Catalogue of Folklore and Mythological Motifs](https://ruthenia.ru/folklore/berezkin/) and [Maps of Myths](https://mapsofmyths.com/). These are the source catalogue interfaces, not the authority for the frozen analytical counts; the bundled release tables and audit manifest remain authoritative for the 926-record analysis.
...
*The Shape of Myth* is an independent research project. It is not affiliated with or endorsed by the Smithsonian Institution, UNESCO, the Library of Congress, The Metropolitan Museum of Art, the Berezkin–Duvakin catalogue team, or the communities and individuals whose linked materials appear in the historical narrative.
